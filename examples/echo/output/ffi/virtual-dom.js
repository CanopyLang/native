// FFI module: VirtualDomFFI
// Auto-generated by the Canopy compiler. Do not edit.

import { A2, A3, A4, F, F2, F3, F4, F5, F6, F7, F8, F9, _List_Cons, _List_Nil, _Platform_export, _Utils_Tuple2 } from '../canopy-runtime.js';
...
globalThis.VirtualDomFFI = Object.assign(globalThis.VirtualDomFFI || {}, { init, text, nodeNS, node, keyedNodeNS, keyedNode, custom: _VirtualDom_custom, map, lazy, lazy2, lazy3, lazy4, lazy5, lazy6, lazy7, lazy8, block2, block3, on, style, property, attribute, attributeNS, noScript, noOnOrFormAction, noInnerHtmlOrFormAction, noJavaScriptUri, noJavaScriptOrHtmlUri, noJavaScriptOrHtmlJson, mapAttribute, cssScoped: _VirtualDom_cssScoped, hydrate: _VirtualDom_hydrate });
Object.assign(globalThis, { _VirtualDom_DANGEROUS_PROTOCOLS, _VirtualDom_DELEGATABLE, _VirtualDom_JSON_SUCCEED, _VirtualDom_MARKER, _VirtualDom_RE_js, _VirtualDom_RE_js_html, _VirtualDom_RE_on_formAction, _VirtualDom_RE_script, _VirtualDom_addClass, _VirtualDom_appendChild, _VirtualDom_applyAttrs, _VirtualDom_applyAttrsNS, _VirtualDom_applyEvents, _VirtualDom_applyFacts, _VirtualDom_applyPatches, _VirtualDom_applyStyles, _VirtualDom_blockIdCounter, _VirtualDom_blockTemplates, _VirtualDom_buildTNode, _VirtualDom_collectLivePaths, _VirtualDom_cssRuleCache, _VirtualDom_cssScoped, _VirtualDom_cssSheet, _VirtualDom_custom, _VirtualDom_dangerousProperty, _VirtualDom_dekey, _VirtualDom_delegatedListeners, _VirtualDom_delegationRoot, _VirtualDom_diff, _VirtualDom_diffFacts, _VirtualDom_divertHrefToApp_current, _VirtualDom_divertHrefToApp_pop, _VirtualDom_divertHrefToApp_push, _VirtualDom_divertHrefToApp_stack, _VirtualDom_doc, _VirtualDom_ensureDelegated, _VirtualDom_equalEvents, _VirtualDom_eventsMap, _VirtualDom_fastHydrate, _VirtualDom_forceThunk, _VirtualDom_getCssSheet, _VirtualDom_hashCss, _VirtualDom_hydrate, _VirtualDom_hydrateClone, _VirtualDom_hydrateHelp, _VirtualDom_initDelegation, _VirtualDom_instantiateTNodeSchema, _VirtualDom_isDangerousUri, _VirtualDom_isOk, _VirtualDom_lisIndices, _VirtualDom_makeCallback, _VirtualDom_mapEventRecord, _VirtualDom_mapEventTuple, _VirtualDom_mapHandler, _VirtualDom_navForcedVNode, _VirtualDom_nextMarkerId, _VirtualDom_organizeFacts, _VirtualDom_pairwiseRefEqual, _VirtualDom_passiveFalse, _VirtualDom_passiveSupported, _VirtualDom_passiveTrue, _VirtualDom_quickVisit, _VirtualDom_redrawTNode, _VirtualDom_render, _VirtualDom_renderBlock, _VirtualDom_renderDomNode, _VirtualDom_singleAttrFacts, _VirtualDom_stampMarkers, _VirtualDom_tNodeDomNode, _VirtualDom_thunk, _VirtualDom_toHandlerInt, _VirtualDom_treeMap, _VirtualDom_update, _VirtualDom_updateTNode, _VirtualDom_updateTNodeKeyedKids, _VirtualDom_updateTNodeKids, _VirtualDom_virtualize, _VirtualDom_wrapEventNode, __2_BLOCK, __2_CUSTOM, __2_KEYED_NODE, __2_NODE, __2_TAGGER, __2_TEXT, __2_THUNK });
